...
{
    public static IActionResult ToIActionResult(this AppResult result, ControllerBase controller)
    {
        if (result.IsSuccess)
    ...
    public static IActionResult ToIActionResult<T>(this AppResult<T> result, ControllerBase controller)
    {
        if (result.IsSuccess)
    ...
    public static ActionResult ToActionResult<T>(this AppResult<T> result, ControllerBase controller)
    {
        if (result.IsSuccess)
            return controller.Ok();
        
        return controller.ProblemFromErrorActionResult(result.Error);
    }
    ...
    private static ActionResult ProblemFromErrorActionResult(this ControllerBase controller, AppError? error)
    {
        // Fallback safety
        if (error == null)
        {
