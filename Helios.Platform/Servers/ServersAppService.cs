...
//        public ServersAppService(IServerManager manager, ICurrentUserContext current, ILogger<ServersAppService> logger)
//        {
//            _manager = manager;
//            _current = current;
//            _logger = logger;
...
//        Task<AppResult<PagedResponse<ServerDto>>> IServersAppService.GetListAsync(GetServersRequest request, CancellationToken ct)
//        {
